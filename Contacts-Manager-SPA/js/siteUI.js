...
function Init_UI() {
    ...
    $("#more").on("click", async function(){
        let categories = await API_GetBookmarks();
            ...
            <div class="bookmarkRow" bookmark_id=${bookmark.Id}">
                <div class="bookmarkContainer">
                    <div class="bookmarkLayout">
                        <img class="favicon" src="https://www.google.com/s2/favicons?domain=${bookmark.Url}"></img>
...
function renderBookmarkForm(bookmark = null) {
    ...
    $("#content").append(`
        <form class="form" id="bookmarkForm">
            ...
            <img rel="icon" type="image/x-icon" class="favicon" src="https://www.google.com/s2/favicons?domain=${bookmark.Url}"></img>
            <br>
    ...
    return $(`
     <div class="bookmarkRow" bookmark_id=${bookmark.Id}">
        <div class="bookmarkContainer noselect">
            <div class="bookmarkLayout">
                <a href="${bookmark.Url}"> <img class="favicon" src="https://www.google.com/s2/favicons?domain=${bookmark.Url}"></img> </a>
